...
const teacherRoutes = [
    ...
    {
        path: '/uredjivanjeAkademskeGodine/:id',
        exact: true,
        name: 'UredjivanjeAkademskeGodine',
        component: UredjivanjeAkademskeGodine
    },
    {
        path: '/kreiranjeAkademskeGodine',
        exact: true,
        name: 'KreiranjeAkademskeGodine',
        component: KreiranjeAkademskeGodine
    },
    //spirale
    ...
    {
        path: '/pojedinacnoKreiranjeIzvjestaja',
        exact: true,
        name: 'PojedinacnoKreiranjeIzvjestaja',
        component: PojedinacnoKreiranje
    },
];
